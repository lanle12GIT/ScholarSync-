...
const DashboardPage: React.FC = () => {
  ...
  const stats = [
    { title: 'YOUR TOPICS', value: statsData.topicCount.toString(), extra: '', extraColor: '#52c41a', bgColor: '#e6f4ff', icon: <FolderOpenOutlined style={{ color: '#1677ff', fontSize: '16px' }} /> },
    { title: 'NEW PAPERS ( TOPIC FOLLOWED)', value: statsData.newPaperCount.toString(), bgColor: '#f6ffed', icon: <FileTextOutlined style={{ color: '#52c41a', fontSize: '16px' }} /> },
    { title: 'FAVORITE PAPERS', value: statsData.favoriteCount.toString(), bgColor: '#fff2e8', icon: <HeartOutlined style={{ color: '#fa8c16', fontSize: '16px' }} /> },
    { title: 'NOTIFICATIONS', value: statsData.notificationCount.toString(), bgColor: '#f9f0ff', icon: <BellOutlined style={{ color: '#722ed1', fontSize: '16px' }} /> },
  ];
      ...
      <Row gutter={[16, 16]} className="stats-row">
        {stats.map((stat, index) => (
          <Col xs={24} sm={12} md={6} key={index}>
            <Card className="stat-card" variant="outlined" style={{ backgroundColor: stat.bgColor, border: '2px solid #d1d5db' }}>
